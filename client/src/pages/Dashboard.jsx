  ...
  return (
    <div className="dashboard">
      <div className="balance-card card">
        ...
        <div className="skeleton" style={{ width: 140, height: 36, marginBottom: 12 }} />
      ...
      <div>
        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="skeleton" style={{ height: 52, borderRadius: "var(--radius-md)", marginBottom: 8 }} />
        ))}
      </div>
    </div>
  );
...
export default function Dashboard() {
  ...
  const totalPending = pendingLocal.reduce((s, p) => s + Number(p.amount || 0), 0);
    ...
    <div className="dashboard">
      ...
      <section className="stats-row">
        <div className="stat-item">
          <span className="stat-item__value mono">{transactions.length}</span>
        ...
        <div className="stat-item">
          <span className="stat-item__value mono">{pendingLocal.length}</span>
      ...
      <section className="quick-actions">
        <Link to="/send" className="quick-action">
          ...
          <div className="quick-action__text">
            ...
            <span className="quick-action__hint">Transfer to anyone</span>
          </div>
        </Link>
        <Link to="/transactions" className="quick-action">
          ...
          <div className="quick-action__text">
            ...
            <span className="quick-action__hint">View all payments</span>
          </div>
        </Link>
      </section>
